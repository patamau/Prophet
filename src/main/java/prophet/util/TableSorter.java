...
/**
 * This class provides a decorated table model
 * allowing rows to be sorted.<br>
 * 
 * Adapted to Java 5.0
 * 
...
public class TableSorter extends AbstractTableModel {
    ...
    private Row[] getViewToModel() {
        if (viewToModel == null) {
            ...
            if(viewToModel==null) return new Row[0];
    ...
    public int modelIndex(int viewIndex) {
    	if(getViewToModel().length<=viewIndex) return 0;
