...
public class LayersFloatingWidget extends FloatingWidgetBase implements IRendererListener, ListSelectionListener, MouseListener, ActionListener {

	private final static Logger logger = Logger.getLogger(LayersFloatingWidget.class);
	...
	public LayersFloatingWidget(final WorldRendererComponent worldRenderer, final Frame frame) {
		super(WTITLE, frame);
		...
		final JPanel layersPanel = new JPanel(new BorderLayout());
