...
public class TownsFloatingWidget extends FloatingWidgetBase implements IWorldListener, ListSelectionListener, MouseListener, ActionListener {

	private final static Logger logger = Logger.getLogger(TownsFloatingWidget.class);
	...
	public TownsFloatingWidget(final ISetting setting, final ITownSelectionManager selectionManager, final Frame parent) {
		super(WTITLE, parent);
		...
		final JPanel townsPanel = new JPanel(new BorderLayout());
