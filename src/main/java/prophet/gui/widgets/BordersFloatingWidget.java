...
public class BordersFloatingWidget extends FloatingWidgetBase implements IWorldListener, ListSelectionListener, MouseListener, ActionListener {

	private final static Logger logger = Logger.getLogger(BordersFloatingWidget.class);
	private final static String WTITLE = "Borders";
	...
	public BordersFloatingWidget(final ISetting setting, final IBorderSelectionManager selectionManager, final Frame parent) {
		super(WTITLE, parent);
		...
		final JPanel bordersPanel = new JPanel(new BorderLayout());
		bordersPanel.setBorder(BorderFactory.createTitledBorder("Borders"));
		final JScrollPane sp = new JScrollPane(bordersList);
		bordersPanel.add(sp);
